...
public class RailFenceGui extends JInternalFrame {
	...
	public RailFenceGui() {
		...
		btnEncrypt.addActionListener(new ActionListener() {
			...
			{
			/*	 int r=Integer.parseInt(cb_key.getSelectedItem().toString()),len=En_txt.getText().length();
			 ...
			 Dn_txt.setText("Encrypted : "+cipherText);*/
               ...
               try {
				String cipherText=rf.Encryption(En_txt.getText().toString(),Integer.parseInt(cb_key.getSelectedItem().toString()));
					 Dn_txt.setText("");
					 Dn_txt.setText("Encrypted : "+cipherText);				
		...
		btnDecrypt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				 /* int r=Integer.parseInt(cb_key.getSelectedItem().toString()),len=Dn_txt.getText().length();
				  int c=len/Integer.parseInt(cb_key.getSelectedItem().toString());
				  char mat[][]=new char[r][c];
				  int k=0;
			 	...
			 	try {
			 		...
			 		String decryptedText=rf.Decryption(En_txt.getText().toString(), Integer.parseInt(cb_key.getSelectedItem().toString()));
			 		Dn_txt.setText("");
