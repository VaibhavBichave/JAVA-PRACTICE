...
public class Decrpt_Caesar extends JInternalFrame {
	private JTextArea encrpyt_textArea;
	private JTextArea key_cb;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Decrpt_Caesar frame = new Decrpt_Caesar();
	...
	public Decrpt_Caesar() {
		...
		// key_cb.setModel(new DefaultComboBoxModel(new String[] {"Select Key Hear !",
		...
		scrollPane_2.setBounds(68, 130, 513, 132);
		getContentPane().add(scrollPane_2);
		key_cb = new JTextArea();
		key_cb.setFont(new Font("Arial", Font.BOLD, 18));
		scrollPane_2.setViewportView(key_cb);
		...
		btn_encryt = new JButton("Decrypt");
		btn_encryt.setFont(new Font("Arial", Font.BOLD, 16));
		btn_encryt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				key = Integer.parseInt(key_cb.getText().toString());
				...
				De_textarea.setText(decryptedMessage);
		...
		lblNewLabel.setIcon(new ImageIcon(
				"C:\\Users\\admin\\Desktop\\Image\\Military_Network\\Elliptic-Curve-Cryptography-Follow-My-Vote.jpg"));
