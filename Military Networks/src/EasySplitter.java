...
public class EasySplitter extends JFrame implements ActionListener, ItemListener {
  ...
  JComboBox cb;
  JPanel p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24,
      p25;
  ...
  public EasySplitter() {
    ...
    l1.setToolTipText(
        "Double click on each item to set split configuration separately and then press Set button to save it");
    ...
    tf3.addFocusListener(new FocusAdapter() {
      public void focusLost(FocusEvent fe) {
        try {
          ...
          JOptionPane.showMessageDialog((Container) null, tf3.getText() + " : This is not a valid size",
              "EasySplitter 1.4.0", JOptionPane.OK_OPTION);
        }
      }
    });
    getConfig();
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getSource() == b1) {
      ...
      boolean bx = true;
      if (ctr == 0)
        JOptionPane.showMessageDialog((Container) null, "No source file is selected", "EasySplitter 1.4.0",
            JOptionPane.OK_OPTION);
      else if (tf1.getText().equals(""))
        JOptionPane.showMessageDialog((Container) null, "No split folder is entered", "EasySplitter 1.4.0",
            JOptionPane.OK_OPTION);
      else {
        ...
        try {
          ...
          if (bx)
            JOptionPane.showMessageDialog((Container) null, "Splitted Successfully!", "EasySplitter 1.4.0",
                JOptionPane.OK_OPTION);
          else
            JOptionPane.showMessageDialog((Container) null,
                "EasySplitter encounters some errors!  Only Correct files if any are Splitted Successfully!",
                "EasySplitter 1.4.0", JOptionPane.OK_OPTION);
        } catch (Exception ef) {
          JOptionPane.showMessageDialog((Container) null, "Destination folder is not entered properly",
              "EasySplitter 1.4.0", JOptionPane.OK_OPTION);
        }
      ...
      if (tf4.getText().equals(""))
        JOptionPane.showMessageDialog((Container) null, "No split file is entered", "EasySplitter 1.4.0",
            JOptionPane.OK_OPTION);
      else if (!(new File(tf4.getText()).exists()))
        JOptionPane.showMessageDialog((Container) null, "Split file you specified not found or not correct!",
            "EasySplitter 1.4.0", JOptionPane.OK_OPTION);
      else if (tf5.getText().equals(""))
        JOptionPane.showMessageDialog((Container) null, "Merge folder should be entered", "EasySplitter 1.4.0",
            JOptionPane.OK_OPTION);
      else {
        ...
        try {
          ...
          JOptionPane.showMessageDialog((Container) null, "Error occured in merging: Not merged", "EasySplitter 1.4.0",
              JOptionPane.OK_OPTION);
        }
      }
      ...
      try {
        ...
        if (!flc.exists())
          JOptionPane.showMessageDialog((Container) null, "Comment File not found!", "EasySplitter 1.4.0",
              JOptionPane.OK_OPTION);
        else {
        ...
        JOptionPane.showMessageDialog((Container) null, "Unreadable error!", "EasySplitter 1.4.0",
            JOptionPane.OK_OPTION);
      }
    } else if (e.getSource() == b13) {
      try {
        if (tf4.getText().equals("")) {
          JOptionPane.showMessageDialog((Container) null, "No split file specified!", "EasySplitter 1.4.0",
              JOptionPane.OK_OPTION);
        } else if (!(new File(tf4.getText()).exists())) {
          JOptionPane.showMessageDialog((Container) null, "Split file you specified not found or not correct!",
              "EasySplitter 1.4.0", JOptionPane.OK_OPTION);
          ...
          if (!(beg.equals("jfs"))) {
            JOptionPane.showMessageDialog((Container) null, "Not a valid split file!", "EasySplitter 1.4.0",
                JOptionPane.OK_OPTION);
          } else {
        ...
        JOptionPane.showMessageDialog((Container) null, "Unexpected Error", "EasySplitter 1.4.0",
            JOptionPane.OK_OPTION);
        clearlab();
      }
      ...
      if (tf6.getText().equals(""))
        JOptionPane.showMessageDialog((Container) null, "Default split folder is not empty", "EasySplitter 1.4.0",
            JOptionPane.OK_OPTION);
      else if (tf7.getText().equals(""))
        JOptionPane.showMessageDialog((Container) null, "Default merge folder is not empty", "EasySplitter 1.4.0",
            JOptionPane.OK_OPTION);
      else {
        setConfig();
        getConfig();
        JOptionPane.showMessageDialog((Container) null, "Default values saved!", "EasySplitter 1.4.0",
            JOptionPane.OK_OPTION);
      }
  ...
  public void setConfig() {
    try {
      ...
      JOptionPane.showMessageDialog((Container) null,
          "Error while writing defaults to the Configuration File!!\nReason : " + eg.getMessage(), "EasySplitter 1.4.0",
          JOptionPane.OK_OPTION);
    }
  }
    ...
    try {
      if (wipe) {
        ...
        if ((new File("A:/")).exists()) {
          ...
          JOptionPane.showMessageDialog((Container) null, "No floppy drive found or Floppy Disk is not inserted!!",
              "EasySplitter 1.4.0", JOptionPane.OK_OPTION);
          return 0;
        }
      }
      ...
      String l1 = new String(
          "jfs" + "," + name + "," + String.valueOf(fsize) + "," + String.valueOf(mtime) + "," + String.valueOf(ronly));
      ...
      String l2 = new String(
          cfile + "," + bfile + "," + String.valueOf(no) + "," + String.valueOf(size) + "," + String.valueOf(lsize));
      ...
      JOptionPane.showMessageDialog((Container) null,
          "Some internal error: Cannot split " + name + "\nReason: " + e.getMessage(), "EasySplitter 1.4.0",
          JOptionPane.OK_OPTION);
      return 0;
    }
  ...
  public int merge(String split, String dest, boolean del) {
    ...
    JOptionPane.showMessageDialog((Container) null, "Merged successfully!", "EasySplitter 1.4.0",
        JOptionPane.OK_OPTION);
    return 1;
  }
  ...
  class help extends javax.swing.JFrame {
    ...
    help() {
      ...
      sp = new JScrollPane(ep, ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS,
      ...
      try {
        ...
        JOptionPane.showMessageDialog((Container) null, "Unable to locate the help file!!", "EasySplitter 1.4.0",
            JOptionPane.OK_OPTION);
      }
    }
  ...
  class sizeset extends javax.swing.JFrame implements ActionListener, ItemListener {
      ...
      stf2.addFocusListener(new FocusAdapter() {
        public void focusLost(FocusEvent fe) {
          try {
            ...
            JOptionPane.showMessageDialog((Container) null, stf2.getText() + " : This is not a valid size",
                "EasySplitter 1.4.0", JOptionPane.OK_OPTION);
          }
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getSource() == sb1) {
        if (rs1.isSelected()) {
          tf8.setText(
              "1-" + String.valueOf(sli1.getSelectedIndex()) + "-" + String.valueOf(pos[sli1.getSelectedIndex()]));
