...
public class EasySplitter extends JFrame implements ActionListener,ItemListener
{
  ...
  JComboBox cb;
  JPanel p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25;
...
//
  ...
  // JOptionPane.showMessageDialog(null,"bornarekalpesh@gmail.com","Devolper",JOptionPane.PLAIN_MESSAGE);
   l1=new JLabel("Source Files:(Double click each to configure splits separately)");
    ...
    c2=new JCheckBox("Wipe removable disk before splitting");
    ...
    fc3.addChoosableFileFilter(new filter1());
     ...
     tf3.addFocusListener(new FocusAdapter()
     {
       public void focusLost(FocusEvent fe)
       {
        ...
        {
           JOptionPane.showMessageDialog((Container)null,tf3.getText()+" : This is not a valid size","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
        }
      }
     });
     getConfig();
 ...
 public void actionPerformed(ActionEvent e)
 {
   ...
   else if(e.getSource()==b5)
   {
     boolean bx=true;
     if(ctr==0)
       JOptionPane.showMessageDialog((Container)null,"No source file is selected","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
     else if(tf1.getText().equals(""))
       JOptionPane.showMessageDialog((Container)null,"No split folder is entered","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
     else
     {
     ...
     for(int i=0;i<ctr;i++)
     {
       boolean wipe=false,del=false,batch=false;
       if(c1.isSelected()) del=true;
       if(c2.isSelected()) wipe=true;
       if(c3.isSelected()) batch=true;
       String jsf=new File(str[i]).getName();
       String dest=f.toString()+"/"+getName(jsf,0);

       int res=split(str[i],dest,comments,no[i],size[i],lsize[i],del,wipe,batch);
       if(res==0)
         bx=false;
     }
      if(bx)
       JOptionPane.showMessageDialog((Container)null,"Splitted Successfully!","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
      else
       JOptionPane.showMessageDialog((Container)null,"EasySplitter encounters some errors!  Only Correct files if any are Splitted Successfully!","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
     }catch(Exception ef){
        JOptionPane.showMessageDialog((Container)null,"Destination folder is not entered properly","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
     }
   ...
   else if(e.getSource()==b10)
   {
     ...
     if(tf4.getText().equals(""))
       JOptionPane.showMessageDialog((Container)null,"No split file is entered","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
     else if(!(new File(tf4.getText()).exists()))
        JOptionPane.showMessageDialog((Container)null,"Split file you specified not found or not correct!","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
     else if(tf5.getText().equals(""))
       JOptionPane.showMessageDialog((Container)null,"Merge folder should be entered","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
     else
     {
       ...
       {
        JOptionPane.showMessageDialog((Container)null,"Error occured in merging: Not merged","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
       }
     }
   }
   ...
   else if(e.getSource()==b12)
   {
     try
     {
       ...
       if (!flc.exists())
        JOptionPane.showMessageDialog((Container)null,"Comment File not found!","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
       else
       {
       ...
       JOptionPane.showMessageDialog((Container)null,"Unreadable error!","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
     }
   }
   else if(e.getSource()==b13)
   {
    try
    {
      if (tf4.getText().equals(""))
      {
        JOptionPane.showMessageDialog((Container)null,"No split file specified!","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
      }
      else if(!(new File(tf4.getText()).exists()))
      {
        JOptionPane.showMessageDialog((Container)null,"Split file you specified not found or not correct!","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
      ...
      else
      {
        ...
        if(!(beg.equals("jfs")))
        {
           JOptionPane.showMessageDialog((Container)null,"Not a valid split file!","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
        }
        else
        {
    ...
    {
      JOptionPane.showMessageDialog((Container)null,"Unexpected Error","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
      clearlab();
    }
   ...
   else if(e.getSource()==b18)
   {
    if(tf6.getText().equals(""))
      JOptionPane.showMessageDialog((Container)null,"Default split folder is not empty","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
    else if(tf7.getText().equals(""))
      JOptionPane.showMessageDialog((Container)null,"Default merge folder is not empty","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
    else
    {
     setConfig();
     getConfig();
     JOptionPane.showMessageDialog((Container)null,"Default values saved!","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
    }
   }
                                  ...
                                  boolean wipe,boolean batch)
 {
    ...
    {
      JOptionPane.showMessageDialog((Container)null,"File not found","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
      return 0;
    }
    try{
    if(wipe)
    {
      ...
      if((new File("A:/")).exists())
       ...
       {
         JOptionPane.showMessageDialog((Container)null,"No floppy drive found or Floppy Disk is not inserted!!","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
         return 0;
       }
    }
  ...
  public int merge(String split,String dest,boolean del)
  {
    ...
    JOptionPane.showMessageDialog((Container)null,"Merged successfully!","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
    return 1;
  }
 ...
 class filter1 extends javax.swing.filechooser.FileFilter
 {
  ...
  class help extends javax.swing.JFrame
  {
    ...
    help()
    {
      ...
      {
        JOptionPane.showMessageDialog((Container)null,"Unable to locate the help file!!","EasySplitter 1.4.0",JOptionPane.OK_OPTION);
      }
    }
  ...
  class about extends javax.swing.JFrame
   {
     ...
     about()
     {
       super("About EasySplitter ");
       la1=new JLabel("Name       : EasySplitter(File Splitter)");
       la2=new JLabel("  Version    : 1.4.0");
       la3=new JLabel("  Developed by :Kalpesh Bornare");
       la4=new JLabel("");
       la5=new JLabel("");
       img=new JLabel(new ImageIcon("images/img.jpg"));
       ta=new JTextArea(5,30);
       ta.setText(" This software is licensed as free software to \n"+
                   "  use and distribute to others. If any doubts,\n"+
                   "  please feel free to mail to: bornarekalpesh@gmail.com");
    ...
    public sizeset()
    {
     ...
     stf2.addFocusListener(new FocusAdapter()
     {
       public void focusLost(FocusEvent fe)
       {
        ...
        { JOptionPane.showMessageDialog((Container)null,stf2.getText()+" : This is not a valid size","EasySplitter 1.4.0",JOptionPane.OK_OPTION);}
